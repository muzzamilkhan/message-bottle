...
// relying on click alone. `sticky top-0` pins it to the top of the scrolling
// input it lives in — not the page — so it stays in reach through a long letter
// without floating free over the rest of the page.
//
...
export function LetterFormatToolbar({
  ...
  return (
    ...
    <div
      // Negative margins cancel the scroll container's px-4 pt-3 so the bar
      // spans edge to edge; its background hides the text that scrolls beneath.
      className="sticky top-0 z-[5] -mx-4 -mt-3 mb-1 flex gap-1 border-b border-sea-100 bg-sea-50/95 px-4 py-1.5 backdrop-blur"
