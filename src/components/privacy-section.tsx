...
const points: PrivacyPoint[] = [
  {
    summary: "Every letter is encrypted and can only be read by you and your child",
    detail:
  ...
  {
    summary: "Photos are not publicly available",
    detail:
  ...
  {
    summary:
      "If you ever decide to remove a child, all their letters and photos are deleted as soon as possible",
    detail:
  ...
  {
    summary:
      "If you delete your account, all your data including letters and photos to your child are removed",
    detail:
